...
const connectionOptions = {
    ...
    mobile: MethodMobile,
    browser: opcion === '1' ? ['𝐒𝐊𝐀𝐑𝐂𝐈𝐓𝐀 𝐁𝐎𝐓', 'Safari', '2.0.0'] : methodCodeQR ? ['𝐒𝐊𝐀𝐑𝐂𝐈𝐓𝐀 𝐁𝐎𝐓', 'Safari', '2.0.0'] : ['Ubuntu', 'Chrome', '20.0.04'],
    auth: {
        creds: state.creds,
...
setInterval(async () => {
  ...
  const bio = `𝑩𝒐𝒕 𝑪𝒓𝒆𝒂𝒕𝒆𝒅 𝑩𝒚 Keroppi 𝑻𝒊𝒎𝒆 𝑨𝒄𝒕𝒊𝒗𝒆𝒅: ${uptime}`;
